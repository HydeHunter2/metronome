...
class MainTabBarController: UITabBarController {
  ...
  func setupUI() {
    ...
    instrumentVC.tabBarItem = UITabBarItem(title: "Drum",
                                           image: UIImage(systemName: "dial"),
                                           selectedImage: UIImage(systemName: "dial.fill"))
    metronomeVC.tabBarItem = UITabBarItem(title: "Metronome",
                                          image: UIImage(systemName: "metronome"),
                                          selectedImage: UIImage(systemName: "mostViewed"))
    noteVC.tabBarItem = UITabBarItem(title: "Melody",
...
extension MainTabBarController: UITabBarControllerDelegate {
  func tabBarController(_ tabBarController: UITabBarController,
    ...
    guard let fromVC = selectedViewController, toVC != fromVC else {
      return false
    }
...
extension MainTabBarController: MainTabBarControllerProtocol {
  func showSettings() {
    guard let settingsVC = settingsVC else {
      return
    }
