...
class SettingsPresenterTest: XCTestCase {
    ...
    func testGettingNumberOfPresets() {
        ...
        model.presets = [Preset](repeating: Preset.empty, count: numberOfPresets)
    ...
    func testGettingNumberOfTicks() {
        ...
        preset.beats = [(instruments: [Instrument?], notes: [Note?])](repeating: (instruments: [], notes: []), count: numberOfTicks)
        model.presets = [preset]
